<?php
/* Write a PHP class called File with properties 
like filename and size. Implement a static
 method to calculate the total size of multiple
  files. */
class File {
    public $filename;
    public $size;
...
echo "Total size of files: $totalSize bytes"; // Output: 4500 bytes
?>